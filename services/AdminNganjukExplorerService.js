...
function insert()
{
  ...
  if(tanggal == "" || judul == "")
  {
    ...
    $.ajax({
        dataType: 'json',
        type:'POST',
        url: 'nganjuk-explorer/insert-data',
        cache: false,
        contentType: false,
        processData: false,
        data:form_data,
...
function detail(id){
  $.ajax({
    dataType: 'json',
    url: 'nganjuk-explorer/ambil-data-by-id/'+id,
...
function update_data()
{
  ...
  $.ajax({
      dataType: 'json',
      type:'POST',
      url: 'nganjuk-explorer/edit-data/'+id,
      cache: false,
      contentType: false,
      processData: false,
      data:form_data,
        ...
        hapus: {
            ...
            action: function(){
              $.ajax({
                dataType: 'json',
                type:'POST',
                url: 'nganjuk-explorer/remove/'+id,
                data:{
                  id:id,
                  isActive:0
                }
        ...
        hapus: {
            ...
            action: function(){
              $.ajax({
                dataType: 'json',
                type:'POST',
                url: 'nganjuk-explorer/activate/'+id,
                data:{
                  id:id,
                  isActive:0
                }
