...
class Calendar {  
    ...
    /********************* PROPERTY ********************/  
    private $dayLabels = array("Senin","Selasa","Rabu","Kamis","Jumat","Sabtu","Minggu");
    ...
    */
    private function _showDay($cellNumber){
        ...
        return '<li id="li-'.$this->currentDate.'" onclick="show('."'".$this->currentDate."'".')" class="'.($cellNumber%7==1?' start ':($cellNumber%7==0?' end ':' ')).
