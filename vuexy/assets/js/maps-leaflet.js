...
(function () {
    ...
    features: [
      {
        type: "Feature",
        id: "01",
        properties: { name: "Germany", density: 226.25 },
        geometry: {
          type: "Polygon",
          coordinates: [
            [
              [9.1875, 54.983667], // Coordinates for a point in Germany
              [9.84375, 54.983667], // Coordinates for a point in Germany
              [9.84375, 52.501008], // Coordinates for a point in Germany
              [9.1875, 52.501008], // Coordinates for a point in Germany
              [9.1875, 54.983667], // Coordinates for a point in Germany
            ],
          ],
        },
  ...
  if (userLocationVar) {
    const userLocation = L.map("userLocation").setView([-7.605, 111.472], 10);
    userLocation.locate({
      setView: true,
      maxZoom: 8,
    });
  ...
  //mapbox
  // --------------------------------------------------------------------
  // var map = L.map("map").setView([-7.559918802162932, 111.96384670506485], 10);
